...
class Quote(object):
	...
	def __init__(self, ask_price, ask_size, bid_price, bid_size, last_trade_price, last_extended_hours_trade_price, previous_close, adjusted_previous_close, previous_close_date, symbol, trading_halted, updated_at):
